...
import type { ClientHabit } from "./habit-manager";
...
export function AddHabitForm({
  ...
  athleteId: string;
  groupId: string;
  onAdded: (habit: ClientHabit) => void;
}) {
  ...
  async function handleAdd(e: React.FormEvent) {
    ...
    if (applyToGroup) {
      ...
      if (forThisAthlete) onAdded(forThisAthlete as ClientHabit);
      setTitle("");
      setSubmitting(false);
      return;
    }
