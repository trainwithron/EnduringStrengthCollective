...
// Mirrors components/athlete/oura-connection.tsx exactly.
  ...
  return (
    <div className="border border-steel/15">
      <div className="flex items-center justify-between h-10 px-3">
        <span className="font-body text-sm">Withings</span>
        {connected ? (
          ...
          <a href={`/api/withings/connect?groupId=${groupId}`} className="font-body text-xs text-rust">
            Connect
          </a>
        )}
      </div>
