...
// Mirrors components/athlete/withings-connection.tsx exactly.
  ...
  return (
    <div className="border border-steel/15">
      <div className="flex items-center justify-between h-10 px-3">
        <span className="font-body text-sm">Google Health</span>
        {connected ? (
          ...
          <a href={`/api/google-health/connect?groupId=${groupId}`} className="font-body text-xs text-rust">
            Connect
          </a>
        )}
      </div>
